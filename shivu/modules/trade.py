...
async def trade(client, message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton("✅ Accept", callback_data="confirm_trade")],
            [InlineKeyboardButton("❌ Decline", callback_data="cancel_trade")]
        ]
    )
...
async def on_trade_callback(client, callback_query):
    ...
    if callback_query.data == "confirm_trade":
        ...
        await callback_query.message.edit_text(f"✅ Trade successful with {callback_query.from_user.mention}!")
...
async def gift(client, message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton("🎁 Accept Gift", callback_data="confirm_gift")],
            [InlineKeyboardButton("❌ Decline", callback_data="cancel_gift")]
        ]
    )

    await message.reply_text(f"Do you really want to gift to {message.reply_to_message.from_user.mention}?", reply_markup=keyboard)
...
async def on_gift_callback(client, callback_query):
    ...
    if callback_query.data == "confirm_gift":
        ...
        await callback_query.message.edit_text(f"🎉 Successfully gifted to [{gift['receiver_first_name']}](tg://user?id={receiver_id})!")
